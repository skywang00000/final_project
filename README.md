...
# Flowchart:
Create a gradio window --> Create some initial things --> Input or generate a sorted list randomly --> Click the search button --> Show the steps. 
...
# Hugging Face Link:
https://huggingface.co/spaces/SKY5815/Final_project](https://huggingface.co/spaces/SKY5815/Final_project
